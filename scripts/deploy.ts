...
async function main() {
   ...
   */
  // await deployContract('CommonStakeERC721EarnuShibaFactory')
  /**
   start deployContract CommonStakeERC721EarnuShibaFactory,
   contract CommonStakeERC721EarnuShibaFactory address 0xbFBe1a39590e15AECb86c0EdC686f30f5737faDf
   contract CommonStakeERC721EarnuShibaFactory deploy transaction hash 0x4200fd3ca0ef62197976b31897e710aa15e70d80934c3dcc11285315b5dcb802
   finish deployContract CommonStakeERC721EarnuShibaFactory
   start deployContract CommonStakeERC721EarnuShibaFactory,
   contract CommonStakeERC721EarnuShibaFactory address 0x5138202750fB67b4f9D9316Ee7805F0cEC2Bd1E1
   contract CommonStakeERC721EarnuShibaFactory deploy transaction hash 0xab080c5b13da3873fe7e21865ebf37822b708791b8160e140bafcd5e94f14a85
   finish deployContract CommonStakeERC721EarnuShibaFactory
   */
