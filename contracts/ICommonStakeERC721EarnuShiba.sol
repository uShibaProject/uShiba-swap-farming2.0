...
interface ICommonStakeERC721EarnuShiba {
    ...
    event EmergencyUnstakeAllFromuShiba(address indexed user, uint256 amount);
    ...
    function emergencyUnstakeAllFromuShiba(uint256 _amount) external;
