...
const uShibaAddress: { [name: string]: string } = {
...
const uShibaBnbBlpAddress: { [name: string]: string } = {
...
describe('EarnuShibaCommonMaster', () => {
  beforeEach(async () => {
    const commonMasterFactory: CommonMaster__factory = await ethers.getContractFactory('CommonMaster')
    commonMaster = commonMasterFactory.attach(earnuShibaMasterAddress[network.name])
    erc20Factory = await ethers.getContractFactory('ERC20')
    token = erc20Factory.attach(uShibaAddress[network.name])
  })
  ...
  it('addNftPools', async () => {
    // let tx = await commonMaster.add(10, uShibaMuskMixerCommonStakeERC721EarnuShibaAddress[network.name], false)
    // console.log(`add ${tx.hash}`)
    // await tx.wait()
    // tx = await commonMaster.add(10, doggyEquipmentCommonStakeERC721EarnuShibaAddress[network.name], false)
    // console.log(`add ${tx.hash}`)
    // // await tx.wait()
    // console.log(`add done`)
    // tx = await commonMaster.add(10, barkingNFTCommonStakeERC721EarnuShibaAddress[network.name], false)
    // console.log(`add ${tx.hash}`)
    // // await tx.wait()
    // console.log(`add done`)
    // tx = await commonMaster.add(10, doggyNFTCommonStakeERC721EarnuShibaAddress[network.name], false)
    // console.log(`add ${tx.hash}`)
    // // await tx.wait()
    // console.log(`add done`)
    // tx = await commonMaster.add(10, uShibaSoccerCommonStakeERC721EarnuShibaAddress[network.name], false)
    // console.log(`add ${tx.hash}`)
    // // await tx.wait()
    // console.log(`add done`)

    let tx = await commonMaster.add(10, carNFTCommonStakeERC721EarnuShibaAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    tx = await commonMaster.add(200, comboNFTCommonStakeERC721EarnuShiba[network.name], false)
    console.log(`add ${tx.hash}`)
    tx = await commonMaster.add(10, pokerCardCommonStakeERC721EarnuShibaAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    // await tx.wait()
    /**
     */
  ...
  it('add', async () => {
    let tx = await commonMaster.add(200, uShibaBnbBlpAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    await tx.wait()
    console.log(`add done`)
    ...
    await tx.wait()
    console.log(`add done`)
    tx = await commonMaster.add(200, uShibaAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    await tx.wait()
    console.log(`add done`)
    tx = await commonMaster.add(200, comboNFTCommonStakeERC721EarnuShiba[network.name], false)
    ...
    await tx.wait()
    console.log(`add done`)
    tx = await commonMaster.add(10, carNFTCommonStakeERC721EarnuShibaAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    await tx.wait()
    console.log(`add done`)
    ...
    await tx.wait()
    console.log(`add done`)
    tx = await commonMaster.add(10, uShibaMuskMixerCommonStakeERC721EarnuShibaAddress[network.name], false)
    console.log(`add ${tx.hash}`)
    await tx.wait()
    console.log(`add done`)
  ...
  it('set', async () => {
    let tx = await commonMaster.set(uShibaAddress[network.name], 21)
  ...
  it('updatePool', async () => {
    let tx = await commonMaster.updatePool(uShibaAddress[network.name])
  ...
  it('setLastRewardBlock', async () => {
    let tx = await commonMaster.setLastRewardBlock(uShibaAddress[network.name], 9289235)
    console.log(`updatePool ${tx.hash}`)
    await tx.wait()
    console.log(`updatePool done`)
    /**
  ...
  it('pendingToken', async () => {
    let pendingToken = await commonMaster.pendingToken(uShibaAddress[network.name], '0x05c8c6392380f9613b234b5e3edaacb54a483ec5')
  ...
  it('poolUserInfoMap', async () => {
    let {amount, rewardDebt} = await commonMaster.poolUserInfoMap(uShibaAddress[network.name], '0x05c8c6392380f9613b234b5e3edaacb54a483ec5')
