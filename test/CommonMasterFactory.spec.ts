...
describe('CommonMasterFactory', () => {
  ...
  it('createEarnuShiba2.0CommonMaster', async () => {
    ...
    console.log(`createEarnuShiba2.0CommonMaster ${createCommonMasterTx.hash}`)
    await createCommonMasterTx.wait()
    console.log(`createEarnuShiba2.0CommonMaster done`)
    /**
     // bsct 0x61d777dC41Bb391c491a644974C18fC069Ad3e62
     createEarnuShiba2.0CommonMaster 0x44056a68ebcf72b4b7da5e8eb2a8cb7e3435d3cd1cd76640f2ce137f50fa8c03
     createEarnuShiba2.0CommonMaster done
     */
  })
